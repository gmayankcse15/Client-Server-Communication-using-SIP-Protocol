...
{
    clientUdp5 client = new clientUdp5() ;
    client.doStuff(); 
    ...
    Ringing Ring = new Ringing() ;
     Thread R = new Thread(Ring);
         ...
         public void run() 
     {
        ...
        while(true)
        {
            ...
            try {
                ...
                Logger.getLogger(clientUdp5.class.getName()).log(Level.SEVERE, null, ex);
            }
          ...
          byte[] data = str.getBytes();
              ...
              outPacket = new DatagramPacket(data, 0, data.length, serverAddress, serverPort) ; 
               try {      
                ...
                displayTextField.setText("Line Open...") ;
                openRTPLine();
                R.stop() ;
                t.stop();
           ...
           if(s[0].contains("ACK"))
           {
              displayTextField.setText("Open Line..");
           }
